...
export default {
  ...
  methods: {
    ...
    EmailRecWord(params) {
      ...
      this.emailRecWord = echarts.init(document.getElementById('emailRecWord'), 'halloween')
      this.emailRecWord.setOption(option)
    },
    ...
    CheckTime(params) {
      ...
      function drawPie(chartInstance, scatterData) {
        chartInstance.setOption({
          series: getPieSeries(scatterData, chartInstance)
        });
      }
      ...
      setTimeout(() => drawPie(this.checkTime, scatterData), 10);
    },
