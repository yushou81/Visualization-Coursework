...
<div class="databaseerror">
  <div id="databaseerror" style="width:100%; height:500px;"></div>
</div>
</template>
...
export default {
  ...
  mounted: function() {
    this.databaseerror = echarts.init(document.getElementById('databaseerror'), 'halloween')
    this.databaseerror.setOption(this.depOption)
